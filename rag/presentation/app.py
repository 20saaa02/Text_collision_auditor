...
from entity.dataApp import textIntoFactsGet, textIntoFactsResult, ErrorClass, prepareDBResult, prepareDBGet, checkCollisionOneQueryResult, \
...
from entity.dataDB import findTopNearestDBGet, loadEmbeddingsDBGet, initDBGet, returnAllFactsFromDBGet
